...
public class CalendarBookingServiceHttp {
	...
	public static com.liferay.calendar.model.CalendarBooking
		getNextCalendarBooking(
			HttpPrincipal httpPrincipal, long companyId, long[] calendarIds,
			com.liferay.calendar.model.CalendarBooking firstCalendarBooking,
			int[] statuses, java.util.TimeZone timeZone) {

		try {
			MethodKey methodKey = new MethodKey(
				CalendarBookingServiceUtil.class, "getNextCalendarBooking",
				_getNextCalendarBookingParameterTypes20);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, companyId, calendarIds, firstCalendarBooking,
				statuses, timeZone);
	...
	private static final Class<?>[]
		_getNewStartTimeAndDurationCalendarBookingParameterTypes19 =
			new Class[] {long.class, long.class, long.class};
	private static final Class<?>[] _getNextCalendarBookingParameterTypes20 =
		new Class[] {
			long.class, long[].class,
			com.liferay.calendar.model.CalendarBooking.class, int[].class,
			java.util.TimeZone.class
		};
	private static final Class<?>[] _hasChildCalendarBookingsParameterTypes21 =
		new Class[] {long.class};
	...
	private static final Class<?>[]
		_moveCalendarBookingToTrashParameterTypes24 = new Class[] {long.class};
	private static final Class<?>[]
		_restoreCalendarBookingFromTrashParameterTypes25 = new Class[] {
			long.class
		};
