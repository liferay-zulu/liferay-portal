...
public class ObjectRelationshipPersistenceImpl
	 ...
	 */
	@Override
	public List<ObjectRelationship> findByODI1_ODI2(
		long objectDefinitionId1, long objectDefinitionId2) {

		return findByODI1_ODI2(
			objectDefinitionId1, objectDefinitionId2, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the object relationships where objectDefinitionId1 = &#63; and objectDefinitionId2 = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>ObjectRelationshipModelImpl</code>.
	 * </p>
	...
	@Override
	public List<ObjectRelationship> findByODI1_ODI2(
		long objectDefinitionId1, long objectDefinitionId2, int start,
		int end) {

		return findByODI1_ODI2(
			objectDefinitionId1, objectDefinitionId2, start, end, null);
	}

	/**
	 * Returns an ordered range of all the object relationships where objectDefinitionId1 = &#63; and objectDefinitionId2 = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>ObjectRelationshipModelImpl</code>.
	 * </p>
	...
	@Override
	public List<ObjectRelationship> findByODI1_ODI2(
		long objectDefinitionId1, long objectDefinitionId2, int start, int end,
		OrderByComparator<ObjectRelationship> orderByComparator) {

		return findByODI1_ODI2(
			objectDefinitionId1, objectDefinitionId2, start, end,
			orderByComparator, true);
	}
	...
	public List<ObjectRelationship> findByODI1_ODI2(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByODI1_ODI2;
				finderArgs = new Object[] {
			...
			finderPath = _finderPathWithPaginationFindByODI1_ODI2;
			finderArgs = new Object[] {
				objectDefinitionId1, objectDefinitionId2, start, end,
				orderByComparator
			};
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_ODI1_ODI2_OBJECTDEFINITIONID1_2);

			sb.append(_FINDER_COLUMN_ODI1_ODI2_OBJECTDEFINITIONID2_2);
	...
	/**
	 * Returns the first object relationship in the ordered set where objectDefinitionId1 = &#63; and objectDefinitionId2 = &#63;.
	 *
	 * @param objectDefinitionId1 the object definition id1
	 * @param objectDefinitionId2 the object definition id2
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public ObjectRelationship findByODI1_ODI2_First(
			long objectDefinitionId1, long objectDefinitionId2,
			OrderByComparator<ObjectRelationship> orderByComparator)
		throws NoSuchObjectRelationshipException {

		ObjectRelationship objectRelationship = fetchByODI1_ODI2_First(
			objectDefinitionId1, objectDefinitionId2, orderByComparator);
	 ...
	 */
	@Override
	public ObjectRelationship fetchByODI1_ODI2_First(
		long objectDefinitionId1, long objectDefinitionId2,
		OrderByComparator<ObjectRelationship> orderByComparator) {

		List<ObjectRelationship> list = findByODI1_ODI2(
			objectDefinitionId1, objectDefinitionId2, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last object relationship in the ordered set where objectDefinitionId1 = &#63; and objectDefinitionId2 = &#63;.
	 *
	 * @param objectDefinitionId1 the object definition id1
	 * @param objectDefinitionId2 the object definition id2
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public ObjectRelationship findByODI1_ODI2_Last(
			long objectDefinitionId1, long objectDefinitionId2,
			OrderByComparator<ObjectRelationship> orderByComparator)
		throws NoSuchObjectRelationshipException {

		ObjectRelationship objectRelationship = fetchByODI1_ODI2_Last(
			objectDefinitionId1, objectDefinitionId2, orderByComparator);
	 ...
	 */
	@Override
	public ObjectRelationship fetchByODI1_ODI2_Last(
		long objectDefinitionId1, long objectDefinitionId2,
		OrderByComparator<ObjectRelationship> orderByComparator) {

		int count = countByODI1_ODI2(objectDefinitionId1, objectDefinitionId2);
		...
		List<ObjectRelationship> list = findByODI1_ODI2(
			objectDefinitionId1, objectDefinitionId2, count - 1, count,
			orderByComparator);
	...
	/**
	 * Returns the object relationships before and after the current object relationship in the ordered set where objectDefinitionId1 = &#63; and objectDefinitionId2 = &#63;.
	 *
	 * @param objectRelationshipId the primary key of the current object relationship
	 * @param objectDefinitionId1 the object definition id1
	 * @param objectDefinitionId2 the object definition id2
	 ...
	 */
	@Override
	public ObjectRelationship[] findByODI1_ODI2_PrevAndNext(
			long objectRelationshipId, long objectDefinitionId1,
			long objectDefinitionId2,
			OrderByComparator<ObjectRelationship> orderByComparator)
		throws NoSuchObjectRelationshipException {
		...
		try {
			...
			array[0] = getByODI1_ODI2_PrevAndNext(
				session, objectRelationship, objectDefinitionId1,
				objectDefinitionId2, orderByComparator, true);

			array[1] = objectRelationship;

			array[2] = getByODI1_ODI2_PrevAndNext(
				session, objectRelationship, objectDefinitionId1,
				objectDefinitionId2, orderByComparator, false);
	...
	protected ObjectRelationship getByODI1_ODI2_PrevAndNext(
		Session session, ObjectRelationship objectRelationship,
		long objectDefinitionId1, long objectDefinitionId2,
		OrderByComparator<ObjectRelationship> orderByComparator,
		boolean previous) {
	...
	/**
	 * Removes all the object relationships where objectDefinitionId1 = &#63; and objectDefinitionId2 = &#63; from the database.
	 *
	 * @param objectDefinitionId1 the object definition id1
	 * @param objectDefinitionId2 the object definition id2
	 */
	@Override
	public void removeByODI1_ODI2(
		long objectDefinitionId1, long objectDefinitionId2) {
	...
	/**
	 * Returns the number of object relationships where objectDefinitionId1 = &#63; and objectDefinitionId2 = &#63;.
	 *
	 * @param objectDefinitionId1 the object definition id1
	 * @param objectDefinitionId2 the object definition id2
	 * @return the number of matching object relationships
	...
	public int countByODI1_ODI2(
		...
		FinderPath finderPath = _finderPathCountByODI1_ODI2;
	...
	private static final String _FINDER_COLUMN_ODI1_ODI2_OBJECTDEFINITIONID1_2 =
		"objectRelationship.objectDefinitionId1 = ? AND ";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByODI1_ODI2 = new FinderPath(
			...
			new String[] {"objectDefinitionId1", "objectDefinitionId2"}, true);

		_finderPathWithoutPaginationFindByODI1_ODI2 = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByODI1_ODI2",
			new String[] {Long.class.getName(), Long.class.getName()},
			new String[] {"objectDefinitionId1", "objectDefinitionId2"}, true);

		_finderPathCountByODI1_ODI2 = new FinderPath(
