...
public class ObjectRelationshipUtil {
	 ...
	 * @return the matching object relationships
	 */
	public static List<ObjectRelationship> findByODI1_ODI2(
		long objectDefinitionId1, long objectDefinitionId2) {

		return getPersistence().findByODI1_ODI2(
	 ...
	 * @throws NoSuchObjectRelationshipException if a matching object relationship could not be found
	 */
	public static ObjectRelationship findByODI1_ODI2_First(
			long objectDefinitionId1, long objectDefinitionId2,
			OrderByComparator<ObjectRelationship> orderByComparator)
		throws com.liferay.object.exception.NoSuchObjectRelationshipException {

		return getPersistence().findByODI1_ODI2_First(
	 ...
	 * @return the first matching object relationship, or <code>null</code> if a matching object relationship could not be found
	 */
	public static ObjectRelationship fetchByODI1_ODI2_First(
		long objectDefinitionId1, long objectDefinitionId2,
		OrderByComparator<ObjectRelationship> orderByComparator) {

		return getPersistence().fetchByODI1_ODI2_First(
			objectDefinitionId1, objectDefinitionId2, orderByComparator);
	}
	 ...
	 * @throws NoSuchObjectRelationshipException if a matching object relationship could not be found
	 */
	public static ObjectRelationship findByODI1_ODI2_Last(
			long objectDefinitionId1, long objectDefinitionId2,
			OrderByComparator<ObjectRelationship> orderByComparator)
		throws com.liferay.object.exception.NoSuchObjectRelationshipException {

		return getPersistence().findByODI1_ODI2_Last(
			objectDefinitionId1, objectDefinitionId2, orderByComparator);
	}
	 ...
	 * @return the last matching object relationship, or <code>null</code> if a matching object relationship could not be found
	 */
	public static ObjectRelationship fetchByODI1_ODI2_Last(
		long objectDefinitionId1, long objectDefinitionId2,
		OrderByComparator<ObjectRelationship> orderByComparator) {

		return getPersistence().fetchByODI1_ODI2_Last(
			objectDefinitionId1, objectDefinitionId2, orderByComparator);
	}
	 ...
	 * @throws NoSuchObjectRelationshipException if a object relationship with the primary key could not be found
	 */
	public static ObjectRelationship[] findByODI1_ODI2_PrevAndNext(
			long objectRelationshipId, long objectDefinitionId1,
			long objectDefinitionId2,
			OrderByComparator<ObjectRelationship> orderByComparator)
		throws com.liferay.object.exception.NoSuchObjectRelationshipException {

		return getPersistence().findByODI1_ODI2_PrevAndNext(
	 ...
	 * @param objectDefinitionId2 the object definition id2
	 */
	public static void removeByODI1_ODI2(
		long objectDefinitionId1, long objectDefinitionId2) {

		getPersistence().removeByODI1_ODI2(
			objectDefinitionId1, objectDefinitionId2);
	}
	 ...
	 * @return the number of matching object relationships
	 */
	public static int countByODI1_ODI2(
		long objectDefinitionId1, long objectDefinitionId2) {
