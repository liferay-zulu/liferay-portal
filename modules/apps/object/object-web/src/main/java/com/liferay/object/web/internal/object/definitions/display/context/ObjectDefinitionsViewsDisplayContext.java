	...
	public JSONArray getWorkflowStatusJSONArray() {
		return JSONUtil.putAll(
			JSONUtil.put(
				...
				"value", WorkflowConstants.LABEL_APPROVED
			)
		).put(
			JSONUtil.put(
				"label",
				...
				"value", WorkflowConstants.LABEL_DENIED
			)
		).put(
			JSONUtil.put(
				"label",
				...
				"value", WorkflowConstants.LABEL_DRAFT
			)
		).put(
			JSONUtil.put(
				"label",
				...
				"value", WorkflowConstants.LABEL_EXPIRED
			)
		).put(
			JSONUtil.put(
				"label",
				...
				"value", WorkflowConstants.LABEL_INACTIVE
			)
		).put(
			JSONUtil.put(
				"label",
				...
				"value", WorkflowConstants.LABEL_INCOMPLETE
			)
		).put(
			JSONUtil.put(
				"label",
				...
				"value", WorkflowConstants.LABEL_IN_TRASH
			)
		).put(
			JSONUtil.put(
				"label",
				...
				"value", WorkflowConstants.LABEL_PENDING
			)
		).put(
			JSONUtil.put(
				"label",
				...
				"value", WorkflowConstants.LABEL_SCHEDULED
			)
		);
	}
