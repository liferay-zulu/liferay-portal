...
public class WorkflowTaskManagerImpl implements WorkflowTaskManager {
	...
	public List<User> getAssignableUsers(long companyId, long workflowTaskId)
		...
		return _getAllowedUsers(WorkflowConstants.ASSIGN_TASK, workflowTaskId);
	}
	...
	@Override
	public List<User> getUsersAllowedToViewNotifications(
			long companyId, long workflowTaskId)
		throws WorkflowException {

		return _getAllowedUsers(
			WorkflowConstants.VIEW_TASK_NOTIFICATION, workflowTaskId);
	}
	...
	private List<User> _getAllowedUsers(String actionType, long workflowTaskId)
		...
		try {
			...
			if (kaleoTaskInstanceToken.isCompleted() &&
				Objects.equals(actionType, WorkflowConstants.ASSIGN_TASK)) {
	...
	private void _populateAllowedUsers(
		...
		if ((role.getType() == RoleConstants.TYPE_DEPOT) ||
			...
			if (Objects.equals(
				...
				if (Objects.equals(actionType, WorkflowConstants.ASSIGN_TASK)) {
